...
DWORD CTangramEditorDoc<Traits_T>::GetCapabilityOptions()
{
	DWORD dwOptions =
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::GetProperty(VSFTPROPID propid, _Out_ VARIANT *pvar)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::NavigateTo(const TextSpan* pts)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::GetCurrentSpan(_Out_ TextSpan* pts)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::GetLineSize( 
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::Replace( 
	/* [in] */ DWORD dwFlags,
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::GetSpanLength( 
	/* [in] */ const TextSpan* pts,
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::GetLineLength( 
	/* [in] */ LONG iLine,
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::GetLine( 
	/* [in] */ DWORD grfGet,
	/* [in] */ LONG iLine,
	/* [in] */ LONG iStartIndex,
	/* [in] */ LONG iEndIndex,
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::GetLengthOfLine(long iLine, _Out_ long* piLength)
{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::GetLastLineIndex(_Out_ long* piLine, _Out_ long* piIndex)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::SetSelection(
	long iAnchorLine, 
	ViewCol iAnchorCol, 
	long iEndLine, 
	ViewCol iEndCol)
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::GetInitialPattern(_Deref_out_z_ BSTR* pbstrPattern)
{
	*pbstrPattern = NULL;
