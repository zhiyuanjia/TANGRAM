...
/*
ISingleViewEditor is the automation interface for CTangramEditorDoc.  The implementation
of the methods is just a thin wrapper over the site cache and the rich edit control's object
model.
*/

template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::get_DTE(_Deref_out_ _DTE** ppDTE)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::get_Parent(_Deref_out_ _DTE** ppParent)
{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::get_DefaultTabStop(_Out_ float* pfStop)
{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::put_DefaultTabStop(float fStop)
{
	return GetControl().GetITextDocument()->SetDefaultTabStop(fStop);
}

template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::get_Range(_Deref_out_ /*ITextRange*/ IDispatch** ppRange)
{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::get_Selection(_Deref_out_ /*ITextSelection*/ IDispatch** ppSelection)
{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::get_Flags(_Out_ long* piFlags)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::put_Flags(long iFlags)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::FindText(_In_ BSTR bstrToFind)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::SetText(_In_ BSTR bstrToSet)
{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::TypeText(_In_ BSTR bstrToType)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::Cut()
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::Copy()
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::Paste()
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::Delete(long iUnit, long iCount)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::MoveUp(long iUnit, long iCount, long iExtend)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::MoveDown(long iUnit, long iCount, long iExtend)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::MoveLeft(long iUnit, long iCount, long iExtend)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::MoveRight(long iUnit, long iCount, long iExtend)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::EndKey(long iUnit, long iExtend)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::HomeKey(long iUnit, long iExtend)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::RecordCommand(const wchar_t* szCommand)
{
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::RecordKeyStroke(UINT msg, _In_ WPARAM wParam, _In_ LPARAM /*lParam*/)
{
	CStringW strMacro;
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::RecordDelete(bool bBackspace /*= false*/, bool bWord /*= false*/)
{
	if(!m_Recorder.IsRecording(GetVsSiteCache()))
	{
		return;
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::RecordMove(
	LastMacro eState,
	LPCWSTR szDirection,
	MoveScope eScope,
	bool bExtend)
...
template <class Traits_T>
LRESULT CALLBACK CTangramEditorDoc<Traits_T>::RichEditWindowProc(
	_In_ HWND hWnd, 
	UINT msg, 
	_In_ WPARAM wParam, 
	_In_ LPARAM lParam)
{
	...
	CTangramEditorDoc* pDocument = reinterpret_cast<CTangramEditorDoc*>(window.GetWindowLongPtr(GWLP_USERDATA));
...
template <class Traits_T>
IDispatch* CTangramEditorDoc<Traits_T>::GetNamedAutomationObject(_In_z_ BSTR bstrName)
{
