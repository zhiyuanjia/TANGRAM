...
// TangramEditorWindowing.inl

template <class Traits_T>
void CTangramEditorDoc<Traits_T>::SetFontName(_In_ VARIANT *pvarNew)
{
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::SetFontSize(_In_ VARIANT *pvarNew)
{
	VSL_ASSERT(NULL != pvarNew); // Caller should ensure this isn't NULL, so no retail check
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::GetFontName(_Out_ VARIANT *pvarOut)
{
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::GetFontSize(_Out_ VARIANT *pvarOut)
{
	VSL_ASSERT(NULL != pvarOut); // Caller should ensure this isn't NULL, so no retail check
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::SetInfo()
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::StatusBarUpdatePos(_In_ IVsStatusbar* pIVsStatusBar)
{
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::StatusBarUpdateInsMode(_In_ IVsStatusbar* pIVsStatusBar)
{
	CComPtr<IVsStatusbar> spIVsStatusBar = pIVsStatusBar;
...
template <class Traits_T>
long CTangramEditorDoc<Traits_T>::GetTextSelectionFlags()
{
	CComPtr<ITextSelection>	spITextSelection;
	GetTextSelection(spITextSelection);
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::IsSupported(_In_ IDataObject* pDataObject)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
STDMETHODIMP CTangramEditorDoc<Traits_T>::ItemPicked(_In_ IDataObject* pDataObject)
{
	VSL_STDMETHODTRY{
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::IVsToolboxUserHelper(_In_ IDataObject* pDataObject, ATL::CComVariant& vt)
{
...
template <class Traits_T>
bool CTangramEditorDoc<Traits_T>::CanCycleClipboard()
{
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::PasteClipboardObject()
{
	CComPtr<IVsToolboxClipboardCycler> spIVsToolboxClipboardCycler;
	CHKHR(GetVsSiteCache().QueryService(SID_SVsToolbox, &spIVsToolboxClipboardCycler));
...
template <class Traits_T>
bool CTangramEditorDoc<Traits_T>::IsSelectionEmpty()
{
	CComPtr<ITextSelection> spITextSelection;
	GetTextSelection(spITextSelection);
	long iStart = 0;
...
template <class Traits_T>
DWORD CTangramEditorDoc<Traits_T>::GetFontFormatState(DWORD dwEffect)
{
	CComPtr<ITextFont> spITextFont;
	GetTextFont(spITextFont);
...
template <class Traits_T>
VOID CTangramEditorDoc<Traits_T>::SetFontFormatState(DWORD dwEffect)
{
	CComPtr<ITextFont> spITextFont;
	GetTextFont(spITextFont);
...
template <class Traits_T>
DWORD CTangramEditorDoc<Traits_T>::QueryParagraphAlignmentState(long iToQuery)
{
...
template <class Traits_T>
DWORD CTangramEditorDoc<Traits_T>::GetBulletState()
{
	CComPtr<ITextPara> spITextPara;
	GetTextPara(spITextPara);
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::SetParagraphAlignment(long iAlignment)
{
	CComPtr<ITextPara> spITextPara;
	GetTextPara(spITextPara);
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::ToggleBulleted()
{
	CComPtr<ITextPara> spITextPara;
	GetTextPara(spITextPara);
...
template <class Traits_T>
void CTangramEditorDoc<Traits_T>::UpdateVSCommandUI()
{
