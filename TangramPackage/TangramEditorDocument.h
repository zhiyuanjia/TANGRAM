...
class CTangramEditorDocDefaultTraits
{
public:
...
class CTangramEditorDoc : 
	...
	public DocumentPersistanceBase<CTangramEditorDoc<Traits_T>, typename Traits_T::File>,
	...
	public ISelectionContainerSingleItemImpl<CTangramEditorDoc<Traits_T>, ITextDocument>,
	...
	public SingleViewFindInFilesOutputWindowIntegrationImpl<CTangramEditorDoc<Traits_T> >,
	public ATL::IConnectionPointContainerImpl<CTangramEditorDoc<Traits_T> >,
	...
	public ATL::IConnectionPointImpl<CTangramEditorDoc<Traits_T>, &IID_IVsTextViewEvents>,
...
VSL_DECLARE_NOT_COPYABLE(CTangramEditorDoc)
...
// the CTangramEditorDoc object will support via QueryInterface
BEGIN_COM_MAP(CTangramEditorDoc)
...
VSL_BEGIN_COMMAND_MAP()
	...
	VSL_COMMAND_MAP_ENTRY(CLSID_TangramPackageCmdSet, commandIDShowWithWinForm, &OnQueryShowWithWinForm, &OnShowWithWinForm)
	VSL_COMMAND_MAP_ENTRY(CLSID_TangramPackageCmdSet, commandIDShowWithMDIWinForm, &OnQueryShowWithMDIWinForm, &OnShowWithMDIWinForm)
	VSL_COMMAND_MAP_ENTRY(CLSID_TangramPackageCmdSet, commandIDShowWithMFCFrame, &OnQueryShowWithMFCFrame, &OnShowWithMFCFrame)
	VSL_COMMAND_MAP_ENTRY(CLSID_TangramPackageCmdSet, commandIDShowWithMFCMDIFrame, &OnQueryShowWithMFCMDIFrame, &OnShowWithMFCMDIFrame)
	VSL_COMMAND_MAP_ENTRY(CLSID_TangramPackageCmdSet, commandIDShowWithMSWORD, &OnQueryShowWithMSWord, &OnShowWithMSWord)
	VSL_COMMAND_MAP_ENTRY(CLSID_TangramPackageCmdSet, commandIDShowWithMSEXCEL, &OnQueryShowWithMSExcel, &OnShowWithMSExcel)

// Terminate the definition of the command map
VSL_END_VSCOMMAND_MAP()

VSL_BEGIN_MSG_MAP(CTangramEditorDoc)
...
BEGIN_CONNECTION_POINT_MAP(CTangramEditorDoc)
...
protected:
	...
	typedef typename IVsWindowPaneImpl<CTangramEditorDoc<Traits_T> >::VsSiteCache VsSiteCache;

	typedef CTangramEditorDoc<Traits_T> This;
...
// Visual Studio command handlers
	...
	void OnShowWithWinForm(_In_ CommandHandler* /*pSender*/, DWORD /*flags*/, _In_ VARIANT* /*pIn*/, _Out_ VARIANT* /*pOut*/);
	void OnQueryShowWithWinForm(const CommandHandler& /*rSender*/, _Inout_ OLECMD* pOleCmd, _Inout_ OLECMDTEXT* /*pOleText*/);
	void OnShowWithMDIWinForm(_In_ CommandHandler* /*pSender*/, DWORD /*flags*/, _In_ VARIANT* /*pIn*/, _Out_ VARIANT* /*pOut*/);
	void OnQueryShowWithMDIWinForm(const CommandHandler& /*rSender*/, _Inout_ OLECMD* pOleCmd, _Inout_ OLECMDTEXT* /*pOleText*/);

	void OnShowWithMFCFrame(_In_ CommandHandler* /*pSender*/, DWORD /*flags*/, _In_ VARIANT* /*pIn*/, _Out_ VARIANT* /*pOut*/);
	void OnQueryShowWithMFCFrame(const CommandHandler& /*rSender*/, _Inout_ OLECMD* pOleCmd, _Inout_ OLECMDTEXT* /*pOleText*/);
	void OnShowWithMFCMDIFrame(_In_ CommandHandler* /*pSender*/, DWORD /*flags*/, _In_ VARIANT* /*pIn*/, _Out_ VARIANT* /*pOut*/);
	void OnQueryShowWithMFCMDIFrame(const CommandHandler& /*rSender*/, _Inout_ OLECMD* pOleCmd, _Inout_ OLECMDTEXT* /*pOleText*/);

	void OnShowWithMSWord(_In_ CommandHandler* /*pSender*/, DWORD /*flags*/, _In_ VARIANT* /*pIn*/, _Out_ VARIANT* /*pOut*/);
	void OnQueryShowWithMSWord(const CommandHandler& /*rSender*/, _Inout_ OLECMD* pOleCmd, _Inout_ OLECMDTEXT* /*pOleText*/);
	void OnShowWithMSExcel(_In_ CommandHandler* /*pSender*/, DWORD /*flags*/, _In_ VARIANT* /*pIn*/, _Out_ VARIANT* /*pOut*/);
	void OnQueryShowWithMSExcel(const CommandHandler& /*rSender*/, _Inout_ OLECMD* pOleCmd, _Inout_ OLECMDTEXT* /*pOleText*/);
...
// Data members
	...
	VsMacroRecorder<&CLSID_TangramPackageEditorDocument, LastMacro, eLastMacroNone> m_Recorder;
