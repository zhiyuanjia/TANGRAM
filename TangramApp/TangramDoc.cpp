...
IMPLEMENT_DYNCREATE(CTangramDoc, CDocument)

BEGIN_MESSAGE_MAP(CTangramDoc, CDocument)
END_MESSAGE_MAP()
...
void CTangramDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CTangramDoc::InitializeSearchContent()
{
...
void CTangramDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
