...
// TangramApp.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CTangramApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CTangramApp::OnAppAbout)
...
CTangramApp::CTangramApp()
{
	...
	SetAppID(_T("TangramApp.AppID.NoVersion"));
...
BOOL CTangramApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_TangramAppTYPE,
		RUNTIME_CLASS(CTangramDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CTangramView));
	if (!pDocTemplate)
		return FALSE;
...
void CTangramApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// CTangramApp customization load/save methods

void CTangramApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CTangramApp::LoadCustomState()
{
}

void CTangramApp::SaveCustomState()
{
}
