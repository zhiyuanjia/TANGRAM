...
namespace TangramOfficePlus
{
	namespace WordPlus
	{
		namespace WordPlusEvent
		{
			...
			class CTangramWordPlusAppEvents2 : public IDispEventSimpleImpl</*nID =*/ 1, CTangramWordPlusAppEvents2, &__uuidof(ApplicationEvents2)>
			{
			public:
				...
				BEGIN_SINK_MAP(CTangramWordPlusAppEvents2)
			...
			class CTangramWordPlusAppEvents3 : public IDispEventSimpleImpl</*nID =*/ 1, CTangramWordPlusAppEvents3, &__uuidof(ApplicationEvents3)>
			{
			public:
				...
				BEGIN_SINK_MAP(CTangramWordPlusAppEvents3)
			...
			class CTangramWordPlusAppEvents4 : public IDispEventSimpleImpl</*nID =*/ 1, CTangramWordPlusAppEvents4, &__uuidof(ApplicationEvents4)>
			{
			public:
				virtual void __stdcall OnXMLSelectionChange(Selection* Sel, XMLNode* OldXMLNode, XMLNode* NewXMLNode, long* Reason) {}
				...
				BEGIN_SINK_MAP(CTangramWordPlusAppEvents4)
			...
			class CTangramWordPlusDocEvents : public IDispEventSimpleImpl</*nID =*/ 1, CTangramWordPlusDocEvents, &__uuidof(Word::DocumentEvents)>
			{
			public:
				...
				BEGIN_SINK_MAP(CTangramWordPlusDocEvents)
			...
			class CTangramWordPlusDocEvents2 : public IDispEventSimpleImpl</*nID =*/ 1, CTangramWordPlusDocEvents2, &__uuidof(DocumentEvents2)>
			{
			public:
				...
				virtual void __stdcall OnXMLBeforeDelete(Range* DeletedRange, XMLNode* OldXMLNode, VARIANT_BOOL InUndoRedo) {}
				...
				virtual void __stdcall OnBuildingBlockInsert(Range* Range, BSTR Name, BSTR Category, BSTR BlockType, BSTR Template) {}

				BEGIN_SINK_MAP(CTangramWordPlusDocEvents2)
