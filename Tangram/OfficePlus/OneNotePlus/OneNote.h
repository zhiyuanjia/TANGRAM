// Created by Microsoft (R) C/C++ Compiler Version 14.00.23026.0 (adbc2150).
//
// c:\users\sunhui2\documents\visual studio 2015\projects\atlproject4\atlproject4\debug\bin3.tlh
//
// C++ source equivalent of Win32 type library D:\BIN3.tlb
// compiler-generated file created 10/13/15 at 08:37:39 - DO NOT EDIT!
...
enum DockLocation;
enum XMLSchema;
enum TreeCollapsedStateType;
enum NotebookFilterOutType;
struct __declspec(uuid("1d12bd3f-89b6-4077-aa2c-c9dc2bca42f9"))
/* dual interface */ IQuickFilingDialog;
struct __declspec(uuid("627ea7b4-95b5-4980-84c1-9d20da4460b1"))
/* dual interface */ IQuickFilingDialogCallback;
...
enum Error;
struct /* coclass */ Application2;

//
// Smart pointer typedef declarations
//

_COM_SMARTPTR_TYPEDEF(IOneNoteEvents, __uuidof(IOneNoteEvents));
_COM_SMARTPTR_TYPEDEF(IQuickFilingDialog, __uuidof(IQuickFilingDialog));
_COM_SMARTPTR_TYPEDEF(IQuickFilingDialogCallback, __uuidof(IQuickFilingDialogCallback));
...
extern "C" const GUID __declspec(selectany) LIBID_OneNote =
    {0x0ea692ee,0xbb50,0x4e3c,{0xae,0xf0,0x35,0x6d,0x91,0x73,0x27,0x25}};
extern "C" const GUID __declspec(selectany) DIID_IOneNoteEvents =
...
extern "C" const GUID __declspec(selectany) CLSID_Application2 =
    {0xdc67e480,0xc3cb,0x49f8,{0x82,0x32,0x60,0xb0,0xc2,0x05,0x6c,0x8e}};
extern "C" const GUID __declspec(selectany) IID_IQuickFilingDialog =
    {0x1d12bd3f,0x89b6,0x4077,{0xaa,0x2c,0xc9,0xdc,0x2b,0xca,0x42,0xf9}};
extern "C" const GUID __declspec(selectany) IID_IQuickFilingDialogCallback =
