...
namespace TangramOfficePlus
{
	namespace VisioPlus
	{
		...
		HRESULT CTangramVisioAddin::Tangram_Command(IDispatch* RibbonControl)
		{
			return S_OK;
		}
		...
		HRESULT CTangramVisioAddin::GetCustomAddinUI(BSTR RibbonID, BSTR* RibbonXml)
		{
			if (!RibbonXml)
				return E_POINTER;
