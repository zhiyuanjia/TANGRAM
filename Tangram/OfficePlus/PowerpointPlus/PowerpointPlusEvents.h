...
namespace TangramOfficePlus
{
	namespace PowerPointPlus
	{
		namespace PowerPointPlusEvent
		{
			...
			class CTangramPowerpointPlusEApplication : public IDispEventSimpleImpl</*nID =*/ 1, CTangramPowerpointPlusEApplication, &__uuidof(EApplication)>
			{
			public:
				...
				BEGIN_SINK_MAP(CTangramPowerpointPlusEApplication)
