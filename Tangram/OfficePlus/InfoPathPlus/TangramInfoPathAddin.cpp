...
#include "../../stdafx.h"
#include "TangramInfoPathAddin.h"
#include "InfoPathPlusEvents.cpp"

namespace TangramOfficePlus
{
	namespace InfoPathPlus
	{
		CTangramInfoPathAddin::CTangramInfoPathAddin()
		{
		...
		HRESULT CTangramInfoPathAddin::Tangram_Command(IDispatch* RibbonControl)
		{
			return S_OK;
		}

		HRESULT CTangramInfoPathAddin::OnConnection(IDispatch* pHostApp, int ConnectMode)
		{
		...
		HRESULT CTangramInfoPathAddin::OnDisconnection(int DisConnectMode)
		{
		...
		HRESULT CTangramInfoPathAddin::GetCustomAddinUI(BSTR RibbonID, BSTR* RibbonXml)
		{
			if (!RibbonXml)
				return E_POINTER;
		...
		void CTangramInfoPathAddin::WindowCreated(LPCTSTR lpszClass, LPCTSTR strName, HWND hPWnd, HWND hWnd)
		{
