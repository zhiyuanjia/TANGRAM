...
namespace TangramOfficePlus
{
	namespace ExcelPlus
	{
		namespace ExcelPlusEvent
		{
			...
			class CTangramExcelPlusWorkbookEvents : public IDispEventSimpleImpl</*nID =*/ 1, CTangramExcelPlusWorkbookEvents, &__uuidof(WorkbookEvents)>
			{
			public:
				...
				BEGIN_SINK_MAP(CTangramExcelPlusWorkbookEvents)
			...
			class CTangramExcelPlusDocEvents : public IDispEventSimpleImpl</*nID =*/ 1, CTangramExcelPlusDocEvents, &__uuidof(DocEvents)>
			{
			public:
				...
				BEGIN_SINK_MAP(CTangramExcelPlusDocEvents)
			...
			class CTangramExcelPlusChartEvents : public IDispEventSimpleImpl</*nID =*/ 1, CTangramExcelPlusChartEvents, &__uuidof(ChartEvents)>
			{
			public:
				virtual void __stdcall OnActivate() {}
				virtual void __stdcall OnDeactivate() {}
				...
				BEGIN_SINK_MAP(CTangramExcelPlusChartEvents)
			...
			class CTangramExcelPlusAppEvents : public IDispEventSimpleImpl</*nID =*/ 1, CTangramExcelPlusAppEvents, &__uuidof(AppEvents)>
			{
			public:
				...
				BEGIN_SINK_MAP(CTangramExcelPlusAppEvents)
