...
public:
	DECLARE_NO_REGISTRY()
	BEGIN_COM_MAP(CTangramExcelTabCtrl)
	...
	STDMETHOD(Save)()
	{
		...
		CString str;
		str.Format(_T("%d"),m_nActivePageIndex);
...
///////////////////////////////////////////////////////////////////////////
CTangramExcelTabCtrl* PASCAL GetParentTabViewContainer(CWnd* pWnd, BOOL bOnlyActive=TRUE);
///////////////////////////////////////////////////////////////////////////
#endif
#endif // _TABVIEW_H
