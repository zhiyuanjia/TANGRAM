 ...
 * {@code com.tangram.JacobLibraryLoader} resource file, the specified dll
 * will be loaded from the {@code java.library.path}. </li>
 * <li> If {@link #JACOB_DLL_NAME_X86} and {@link #JACOB_DLL_NAME_X64} are
 * defined in the {@code com.tangram.JacobLibraryLoader} resource file, the
...
public final class LibraryLoader {
	...
	public static void loadJacobLibrary() {
		...
		if (path != null) {
			JTangramDispObj.debug("Loading library " + path
			...
			JTangramDispObj.debug("Loading library " + name
					+ " using System.loadLibrary ");
