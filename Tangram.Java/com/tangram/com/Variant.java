 ...
 */
public class Variant extends JTangramDispObj {
	...
	public Object getVariant() {
		if ((this.getvt() & VariantTypeMask) == VariantVariant
			...
			if (JTangramDispObj.isDebugEnabled()) {
				JTangramDispObj.debug("About to call getVariantVariant()");
			}
	 ...
	 *             if the calculated result was a JTangramDispObj usually as a
	 *             result of error
	 */
